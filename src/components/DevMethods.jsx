...
import { devMethods } from "../data";

export default function DevMethods() {
  return (
    <section id="devMethods">
      <div className="container px-5 py-10 mx-auto">
        ...
        <div className="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
          {devMethods.map((devMethods) => (
            <div key={devMethods} className="p-2 sm:w-1/2 w-full">
